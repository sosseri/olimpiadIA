...
- FESTA de veritat → Vols persones per fer festa amb energia? el Jordi i la Irene són la molla que t'espera! Suma't a la comissió i veuràs com és.

- PRESIDENTA / història de la comissió → La Laura és la presidenta. Busca-la i que te'n conti tot sobre el Carrer Papin d'abans i de 
    quan va ressorgir la comissió. Té històries buenísimas.

- DJ / música → El millor DJ de Barcelona el tenim a la comissió de Papin. Busca Oriol i notaràs la diferència.

- HISTÒRIES de Sants, Hostafrancs i la Bordeta → L'Agus és qui te'n ha de parlar.

- DECORACIÓ → Dubtes sobre el guarnit? La Maica porta l'informacio total de tot plegat.

- ESTÀTUES de paper → Necessites fer una estàtua de paper a casa? La Miriam és la teva persona.

- CÓRRER / cross → Ets de córrer? El 18 d'octubre tenim la cross de Sants! Pregunta pel Carles i pel Xavi i ja veuràs.
  
- MUSICA / MUSICS / TIFUS - tenim musics a la comissio! En Jordi i el Agus tocan amb el famos grup de punk Tifus, saps que te algo a veure amb un espectacle teatral? I el Nolasc tocara amb el grup del dia dels joves
  
- ACTRIU - Tenim una jove actriu a la comi. Pregunta per la Montse que et contara com ha comencat
  
 - GRÀFICS / disseny → Vols saber més sobre el disseny dels cartells, Instagram o els programes? O busques gràfics xulos per a la teva festa? La Helena és la nostra experta en gràfica! Busca-la.
  
 - ESTADI → Qui son les persones que apareixed a l'estadi? Pregunta-ho a la Araceli"""
